        ...
        switch (model.bodyType) {
            ...
            case EMMessageBodyTypeImage:
            {
                ...
                if (!image) {
                    image = _model.image;
                    if (!image) {
                        [_bubbleView.imageView af_setImageWithURL:[NSURL URLWithString:_model.fileURLPath] placeholderImage:[UIImage imageNamed:_model.failImageName]];
                    } else {
            ...
            case EMMessageBodyTypeVideo:
            {
                ...
                if (!image) {
                    image = _model.image;
                    if (!image) {
                        [_bubbleView.videoImageView af_setImageWithURL:[NSURL URLWithString:_model.fileURLPath] placeholderImage:[UIImage imageNamed:_model.failImageName]];
                    } else {
