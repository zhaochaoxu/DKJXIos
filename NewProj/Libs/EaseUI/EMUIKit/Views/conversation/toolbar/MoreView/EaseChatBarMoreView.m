...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    [_photoButton setImage:[UIImage imageNamed:@"照片"] forState:UIControlStateNormal];
    [_photoButton setImage:[UIImage imageNamed:@"照片"] forState:UIControlStateHighlighted];
    ...
    [_takePicButton setImage:[UIImage imageNamed:@"拍摄"] forState:UIControlStateNormal];
    [_takePicButton setImage:[UIImage imageNamed:@"拍摄"] forState:UIControlStateHighlighted];
    ...
    if (type == EMChatToolbarTypeChat) {
        ...
        [_videoCallButton setImage:[UIImage imageNamed:@"拍摄"] forState:UIControlStateNormal];
        [_videoCallButton setImage:[UIImage imageNamed:@"拍摄"] forState:UIControlStateHighlighted];
