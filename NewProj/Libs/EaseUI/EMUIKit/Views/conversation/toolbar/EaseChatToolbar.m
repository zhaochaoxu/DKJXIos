...
{
    self = [self initWithFrame:frame horizontalPadding:4 verticalPadding:5 inputViewMinHeight:36 inputViewMaxHeight:150 type:EMChatToolbarTypeGroup];
    if (self) {
...
- (void)_setupSubviews
{
    ...
    //input textview
    _inputTextView = [[EaseTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding+2, self.frame.size.width - self.verticalPadding * 2, self.frame.size.height - (self.verticalPadding+2) * 2)];
    ...
    //change input type
    self.styleChangeButton = [[UIButton alloc] init];
    self.styleChangeButton.accessibilityIdentifier = @"style";
    self.styleChangeButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    [self.styleChangeButton setImage:[UIImage imageNamed:@"语音按钮"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"键盘"] forState:UIControlStateSelected];
    [self.styleChangeButton addTarget:self action:@selector(styleButtonAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"表情"] forState:UIControlStateSelected];
    ...
    EaseChatToolbarItem *styleItem = [[EaseChatToolbarItem alloc] initWithButton:self.styleChangeButton withView:nil];
    [self setInputViewLeftItems:@[styleItem,faceItem]];
...
//    self.recordButton.accessibilityIdentifier = @"record";
    ...
    self.recordButton.layer.borderColor = [UIColor colorWithRed:236/255.0 green:236/255.0 blue:236/255.0 alpha:1].CGColor;
...
//    self.recordButton.hidden = YES;
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"更多3"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"更多3"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"更多3"] forState:UIControlStateSelected];
...
- (void)setInputViewLeftItems:(NSArray *)inputViewLeftItems
{
    ...
    CGFloat itemHeight = self.toolbarView.frame.size.height - (self.verticalPadding+2) * 2;
    for (id item in inputViewLeftItems) {
        if ([item isKindOfClass:[EaseChatToolbarItem class]]) {
            ...
            if (chatItem.button) {
                ...
                oX += (itemFrame.size.width + self.horizontalPadding/2);
...
- (void)setInputViewRightItems:(NSArray *)inputViewRightItems
{
    ...
    CGFloat oMaxX = self.toolbarView.frame.size.width - (self.horizontalPadding+2);
    CGFloat itemHeight = self.toolbarView.frame.size.height - (self.verticalPadding+2) * 2;
