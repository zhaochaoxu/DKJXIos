...
- (void)_setupSubviews
{
    if (_imageView == nil) {
        ...
        _imageView.image = [UIImage imageNamed:@"占位图"];
        ...
        _badgeView.layer.cornerRadius = 16 / 2;
        ...
        [_badgeView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(weakSelf.imageView.mas_right).offset(-7);
            make.top.equalTo(weakSelf.imageView).offset(-7);
